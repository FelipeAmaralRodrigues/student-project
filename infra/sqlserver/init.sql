...
USE [dbstudent]
GO
/****** Object:  Schema [mst]    Script Date: 19/07/2025 14:59:54 ******/
CREATE SCHEMA [mst]
GO
/****** Object:  Table [dbo].[__EFMigrationsHistory]    Script Date: 19/07/2025 14:59:54 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[tb_student]    Script Date: 19/07/2025 14:59:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [mst].[__EFMigrationsHistory]    Script Date: 19/07/2025 14:59:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [mst].[tb_student_created_third_party_registration_saga_data]    Script Date: 19/07/2025 14:59:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [mst].[tb_student_created_third_party_registration_saga_data](
	...
	[response_create_student_third_party_uid_not_received_schedule_token_id] [uniqueidentifier] NULL,
...
GO
INSERT [mst].[__EFMigrationsHistory] ([MigrationId], [ProductVersion]) VALUES (N'20250719175901_AddTables', N'8.0.11')
GO
